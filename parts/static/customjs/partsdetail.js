...
image = $("#image").val();
    ...
    var dataString = 'equipment=' + equipment +'&make=' + make + "&built=" + built+ "&price=" + price + "&parts_type=" + parts_type + "&parts_name=" + parts_name +'&title=' + title + '&name=' + name+ '&description=' + description + "&ref=" + ref + "&code=" + code + "&part=" + part + "&slp=" + slp + "&qty=" + quantity + "&spec=" + specifications + "&remarks=" + remarks + "&serial=" + serial + "&date=" + date + "&fuel=" + fuel + "&engine=" + engine +  "&image=" + image ;
